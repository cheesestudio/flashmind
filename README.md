...
[![Version](https://img.shields.io/badge/version-1.0.0-blue)](./LICENSE)
...
| 主页 | 卡片管理 | 学习统计 | 听力模式 |
|:---:|:---:|:---:|:---:|
| ![主页](src/img/主页.png) | ![卡片](src/img/卡片.png) | ![学习统计](src/img/学习统计.png) | ![听力模式](src/img/听力模式.png) |
...
> 应用采用 [SM-2 算法](https://www.supermemo.com/en/archives1990-2015/english/ol/sm2) 的变体：根据记忆质量动态调整复习间隔，难度因子最小 1.3。
